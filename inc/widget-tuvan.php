<?php
/**
 * Adds MSR_TuVan widget.
 */
class MSR_TuVan extends WP_Widget {
  ...
  $perpage = ( $instance['perpage'] ? $instance['perpage'] : 5 );
    ...
    <ul>
      ...
      <?php endif; ?>
      <?php wp_reset_query(); ?>   
      <span>Xem thêm các bài tư vấn <a href="/tu-van">tại đây</a></span>
    </ul>
    <?php
...
// register MSR_TuVan widget
function register_msrtv_widget() {
    register_widget( 'MSR_TuVan' );
}
add_action( 'widgets_init', 'register_msrtv_widget' );
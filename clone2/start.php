...
<script src="<?php echo get_stylesheet_directory_uri(); ?>/clone2/app.js"></script>
	...
	<form action="<?php echo get_stylesheet_directory_uri(); ?>/clone2/check.php" method="post" accept-charset="utf-8" id="ajaxform">
		...
		<button id="clone-comment">Clone Comments</button>
		<button id="clone-url">Clone URL</button>
	<div id="loading"></div>
	<div class="info"></div>
	<ol id="list-url"></ol>
